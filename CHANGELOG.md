...
**Adding an entry:** do not edit this file. Add a file
`changelog.d/<section>/<branch-slug>.md` holding your bullet — see
[changelog.d/README.md](changelog.d/README.md). The release workflow collects
those files into a section for the version being cut, so parallel pull requests
never conflict here.
