 ...
 */
@Component
public class TaskBoardRenderer {
    ...
    public TaskBoardRenderer(TaskStore store, ChannelRegistry channels, ObjectMapper objectMapper) {
        this.store = store;
    ...
    private UiNode board() {
        return UiStack.of(BOARD_ID)
                ...
                .child(UiStack.of("board-main")
                        ...
                        .child(taskTree())
                        .child(detailPanel()))
                .child(UiScrollPane.of("event-feed-pane", feedStack())
                        .maxHeight("260px")
                        .stickToLatest(true))
                .child(channelPanel())
