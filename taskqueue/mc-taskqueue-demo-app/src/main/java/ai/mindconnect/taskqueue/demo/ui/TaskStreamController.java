...
public class TaskStreamController {
    ...
    public TaskStreamController(ChannelRegistry channels, TaskBoardRenderer board, ObjectMapper objectMapper) {
    ...
    public ResponseEntity<SseEmitter> stream(@RequestParam(name = "lastSeq", defaultValue = "0") long lastSeq) {
        ...
        return ResponseEntity.ok()
                .header("Sui-Stream-Channel", TaskBoardRenderer.BOARD_ID)
