...
public interface AgentTaskRunner {
     ...
     * The system prompt is rendered through the {@link ai.mindconnect.agent.runtime.port.out.PromptRenderer} pipeline,
     ...
     * the standard {@link ai.mindconnect.agent.runtime.port.out.PromptContextProvider} context.
