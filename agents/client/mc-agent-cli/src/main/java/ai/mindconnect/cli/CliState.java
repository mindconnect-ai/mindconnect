 ...
 */
public record CliState(View view, String lastAgentId, String lastSessionId) {
    ...
    public static CliState fromJson(
            ...
            @JsonProperty("lastSessionId") String lastSessionId) {
    ...
    public static CliState sessionList(String agentId) {
        return new CliState(View.SESSION_LIST, agentId, null);
    }

    public static CliState activeSession(String agentId, String sessionId) {
