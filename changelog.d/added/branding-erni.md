- **agents:** **a new "erni" theme, and a branded example instance.** The theme
  is navy on white with a cyan pointer — the active nav row, the current tab
  and a focused field are marked with it, solid actions are navy pills. Pick it
